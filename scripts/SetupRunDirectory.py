...
def parseArguments():
    helpMessage = """
    This sets up the Data directory required for a Dinara run.
    The Data directory becomes the mount point of a huge page filesystem.
    
    After this runs, you can use RunAssembly.py to start a Dinara run can be started in the current directory.
