...
#ifndef DINARA_DEBRUIJN_GRAPH_HPP
#define DINARA_DEBRUIJN_GRAPH_HPP
...
template<class Symbol, uint64_t k, class SequenceId> class dinara::DeBruijnGraphVertex {
public:
...
template<class Symbol, uint64_t k, class SequenceId> class dinara::DeBruijnGraphEdge {
public:
...
template<class Symbol, uint64_t k, class SequenceId> class dinara::DeBruijnGraph :
