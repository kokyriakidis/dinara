#ifndef DINARA_CHOKE_POINTS_HPP
#define DINARA_BOTTLENECKS_HPP
...
template<class Graph> void dinara::findForwardChokePoints(
    const Graph& graph,
    typename Graph::vertex_descriptor startVertex,
    vector<typename Graph::vertex_descriptor>& chokePoints)
{
...
template<class Graph> void dinara::findBackwardChokePoints(
    const Graph& graph,
    typename Graph::vertex_descriptor startVertex,
    vector<typename Graph::vertex_descriptor>& chokePoints)
{
