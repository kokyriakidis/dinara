#ifndef DINARA_MEMORY_MAPPED_UNDIRECTED_GRAPH_HPP
#define DINARA_MEMORY_MAPPED_UNDIRECTED_GRAPH_HPP
...
template<class Vertex, class Edge> class dinara::MemoryMapped::UndirectedGraph {
public:
