...
// Stripped: removed find_snarls/find_snarls_parallel, bdsg overlay, SubgraphOverlay.
// Takes RankedHandleGraph directly instead of wrapping with bdsg overlay.
// License: MIT
...
IntegratedSnarlFinder::IntegratedSnarlFinder(const RankedHandleGraph& graph, const std::unordered_map<nid_t, size_t>& extra_node_weight) : HandleGraphSnarlFinder(&graph), extra_node_weight(extra_node_weight) {
    // Nothing to do!
}
