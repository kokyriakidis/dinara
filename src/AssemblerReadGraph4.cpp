...
class dinara::ReadGraph4AllAlignmentsVertex {
public:
...
class dinara::ReadGraph4: public ReadGraph4BaseClass {
public:
...
// The vertex_descriptor is OrientedReadId::getValue().
class dinara::ReadGraph4AllAlignments: public ReadGraph4AllAlignmentsBaseClass {
public:
    ...
    )
{
    ...
    for(uint64_t alignmentId=0; alignmentId<alignmentData.size(); alignmentId++) {
        ...
        DINARA_ASSERT(orientedReadId0 < orientedReadId1);
    ...
    for(auto& p : endNodesWithNoOutgoingNodesToEndNodesWithNoIncomingNodesSameDisjointSet) {
        ...
        DINARA_ASSERT(orientedReadId.getValue() == value);
        ...
        for(auto& node : p.second) {
            ...
            DINARA_ASSERT(nodeOrientedReadId.getValue() == node);
        ...
        if(endNodesWithNoIncomingNodes[lastNode.getValue()]) {
            ...
            // for(uint64_t alignmentId=0; alignmentId<alignmentData.size(); alignmentId++) {
                ...
                DINARA_ASSERT(alignmentOrientedReadId0 < alignmentOrientedReadId1);
                ...
                if(alignmentOrientedReadId0.getValue() == orientedReadId.getValue() || forwardNeighborsSet.contains(alignmentOrientedReadId0) || forwardNeighborsSet.contains(alignmentOrientedReadId1) ){
                    ...
                    DINARA_ASSERT(readId0v2 < readId1v2);
                    ...
                    DINARA_ASSERT(A0v2.getReadId() == A1v2.getReadId());
                    DINARA_ASSERT(B0v2.getReadId() == B1v2.getReadId());
                    DINARA_ASSERT(A0v2.getStrand() == 1 - A1v2.getStrand());
                    DINARA_ASSERT(B0v2.getStrand() == 1 - B1v2.getStrand());
