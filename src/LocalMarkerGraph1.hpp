#ifndef DINARA_LOCAL_MARKER_GRAPH1_HPP
#define DINARA_LOCAL_MARKER_GRAPH1_HPP
...
class dinara::LocalMarkerGraph1Vertex {
public:
...
class dinara::LocalMarkerGraph1Edge {
public:
...
class dinara::LocalMarkerGraph1 :
