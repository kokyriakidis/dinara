...
vector<string> dinara::filesystem::directoryContents(const string& path)
{
...
string dinara::filesystem::extension(const string& path)
{
...
string dinara::filesystem::getAbsolutePath(const string& path)
{
...
string dinara::filesystem::executablePath() {
    string path;
