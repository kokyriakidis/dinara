#ifndef DINARA_SIMPLE_BAYESIAN_CONSENSUS_CALLER_HPP
#define DINARA_SIMPLE_BAYESIAN_CONSENSUS_CALLER_HPP
...
class dinara::SimpleBayesianConsensusCaller:
    public dinara::ConsensusCaller {
public:
