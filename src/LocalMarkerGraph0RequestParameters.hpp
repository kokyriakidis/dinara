#ifndef DINARA_LOCAL_MARKER_GRAPH_REQUEST_PARAMETERS_HPP
#define DINARA_LOCAL_MARKER_GRAPH_REQUEST_PARAMETERS_HPP
...
class dinara::LocalMarkerGraph0RequestParameters {
public:
