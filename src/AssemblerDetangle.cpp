...
void Assembler::detangle()
{
    ...
    DINARA_ASSERT(markerGraph.edgeMarkerIntervals.isOpen());
    DINARA_ASSERT(assemblyGraph.vertices.isOpen);
    DINARA_ASSERT(assemblyGraph.reverseComplementVertex.isOpen);
    DINARA_ASSERT(assemblyGraph.edges.isOpen);
    DINARA_ASSERT(assemblyGraph.reverseComplementEdge.isOpen);
    DINARA_ASSERT(assemblyGraph.edgesBySource.isOpen());
    DINARA_ASSERT(assemblyGraph.edgesByTarget.isOpen());
    ...
    BGL_FORALL_EDGES(e, graph, AssemblyPathGraph) {
        ...
        DINARA_ASSERT(edge.path.size() == 1);
    ...
    for(AssemblyGraph::VertexId vertexId=0; vertexId<newAssemblyGraph.vertices.size(); vertexId++) {
        ...
        DINARA_ASSERT(it != newVertices.end());
        DINARA_ASSERT(*it == make_pair(markerGraphVertexIdRc, vRc));
    ...
    for(AssemblyGraph::VertexId vertexId=0; vertexId<newAssemblyGraph.vertices.size(); vertexId++) {
        ...
        DINARA_ASSERT(newAssemblyGraph.reverseComplementVertex[vertexIdRc] == vertexId);
    }
    ...
    for(AssemblyGraph::EdgeId newEdgeId=0; newEdgeId<newEdges.size(); newEdgeId++) {
        ...
        DINARA_ASSERT(it0 != newVertices.end());
        DINARA_ASSERT(*it0 == p0);
        ...
        DINARA_ASSERT(it1 != newVertices.end());
        DINARA_ASSERT(*it1 == p1);
    ...
    DINARA_ASSERT(newAssemblyGraph.edges.size() == newAssemblyGraph.edgeLists.size());
