#ifndef DINARA_APPROXIMATE_TOPOLOGICAL_SORT_HPP
#define DINARA_APPROXIMATE_TOPOLOGICAL_SORT_HPP
...
template<class Graph> class dinara::ApproximateTopologicalSortEdgePredicate {
public:
...
template<class Graph> void dinara::approximateTopologicalSort(
    Graph& graph,
