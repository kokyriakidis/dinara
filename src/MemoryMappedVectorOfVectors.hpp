...
#ifndef DINARA_MEMORY_MAPPED_VECTOR_OF_VECTORS_HPP
#define DINARA_MEMORY_MAPPED_VECTOR_OF_VECTORS_HPP
...
template<class T, class Int> class dinara::MemoryMapped::VectorOfVectors {
public:
...
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::beginPass1(Int n)
{
...
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::beginPass2()
{
...
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::endPass2(
...
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::incrementCount(Int index, Int m)
{
    count[index] += m;
}
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::
...
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::store(Int index, const T& t)
{
    (*this)[index][--count[index]] = t;
}
template<class T, class Int>
    void dinara::MemoryMapped::VectorOfVectors<T, Int>::storeMultithreaded(Int index, const T& t)
{
...
// This requires a binary search in the toc.
template<class T, class Int>
    std::pair<Int, Int> dinara::MemoryMapped::VectorOfVectors<T, Int>::find(Int k) const
{
    const auto it = std::upper_bound(toc.begin(), toc.end(), k) - 1;
    const Int i = it - toc.begin();
    const Int j = k - *it;
    DINARA_ASSERT(i < size());
    DINARA_ASSERT(j < size(i));
