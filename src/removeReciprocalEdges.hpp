#ifndef DINARA_REMOVE_RECIPROCAL_ERDGES_HPP
#define DINARA_REMOVE_RECIPROCAL_ERDGES_HPP
...
template<class Graph> void dinara::removeReciprocalEdges(Graph& graph)
{
