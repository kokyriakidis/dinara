    ...
    int distance)
{
    ...
    DINARA_ASSERT(vertexMap.find(assemblyGraphVertexId) == vertexMap.end());
...
int LocalAssemblyGraph::baseCount(edge_descriptor e) const
{
    ...
    DINARA_ASSERT(globalAssemblyGraph.isAssembledEdge(edgeId));
...
void LocalAssemblyGraph::approximateTopologicalSort()
{
    ...
    dinara::approximateTopologicalSort(graph, sortedEdges);
