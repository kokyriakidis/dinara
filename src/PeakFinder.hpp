#ifndef DINARA_PEAK_FINDER_HPP
#define DINARA_PEAK_FINDER_HPP
...
/***********************************************************************************************************************
 ...
 In dinara, the marker coverage distribution has a guaranteed global maximum at 1, and any number of smaller maxima
...
class dinara::PeakFinderException{
public:
