...
)
{
    ...
    while(it0 not_eq end0 and it1 not_eq end1) {
        ...
        DINARA_ASSERT(vertexId0 == vertexId1);
        ...
        DINARA_ASSERT(it0End - it0Begin == 1);
        DINARA_ASSERT(it1End - it1Begin == 1);
...
)
{
    ...
    DINARA_ASSERT(std::is_sorted(orientedReadIds1.begin(), orientedReadIds1.end()));
    ...
    DINARA_ASSERT(orientedReadIds1.size() == inducedAlignments.size());
