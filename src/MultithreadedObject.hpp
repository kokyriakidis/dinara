#ifndef DINARA_MULTITHREADED_OBJECT_HPP
#define DINARA_MULTITHREADED_OBJECT_HPP
...
class dinara::MultithreadedObjectBaseClass {
protected:
...
template<class T> class dinara::MultithreadedObject : public MultithreadedObjectBaseClass {
public:
