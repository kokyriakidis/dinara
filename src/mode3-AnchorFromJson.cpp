    ...
    markers(markers)
{
    ...
    DINARA_ASSERT(
        ...
        candidateAnchorDiscardedDueToLengthCount ==
        candidateAnchorCount);
    DINARA_ASSERT(anchorCount == 2 * candidateAnchorKeptCount);
    DINARA_ASSERT(anchorMarkerIntervals.size() == anchorCount);
    DINARA_ASSERT(anchorSequences.size() == anchorCount);
}
