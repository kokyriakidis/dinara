#ifndef DINARA_MEMORY_MAPPED_ALLOCATOR_HPP
#define DINARA_MEMORY_MAPPED_ALLOCATOR_HPP
...
class dinara::MemoryMapped::ByteAllocator {
public:
...
template<class T> class dinara::MemoryMapped::Allocator {
public:
