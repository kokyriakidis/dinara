#ifndef DINARA_ENUMERATE_PATHS_HPP
#define DINARA_ENUMERATE_PATHS_HPP
...
template<class G> void dinara::enumerateSelfAvoidingPaths(const G &g,
    typename G::vertex_descriptor vA, typename G::vertex_descriptor vB,
    vector<vector<typename G::edge_descriptor> > &paths)
{
...
template<class G, class PathInspector> void dinara::enumeratePaths(
    const G& g,
    typename G::vertex_descriptor v,
...
template<class G, class PathInspector> void dinara::enumeratePathsRecursive(
    const G& g,
    typename G::vertex_descriptor v,
    uint64_t maxPathLength,
    PathInspector& pathInspector,
...
template<class G, class PathInspector> void dinara::enumeratePathsReverse(
    const G& g,
    typename G::vertex_descriptor v,
    uint64_t maxPathLength,
    PathInspector& pathInspector)
...
template<class G, class PathInspector> void dinara::enumeratePathsReverseRecursive(
    const G& g,
    typename G::vertex_descriptor v,
    uint64_t maxPathLength,
    PathInspector& pathInspector,
...
// For each path found, apply the given function object by calling
// functionObject(path), where path is a vector<G::edge_descriptor>
template<class G, class PathInspector> void dinara::enumeratePathsBetween(
    const G& g,
    typename G::vertex_descriptor vA,
    typename G::vertex_descriptor vB,
    PathInspector& pathInspector)
...
template<class G, class PathInspector> void dinara::enumeratePathsBetweenRecursive(
    const G& g,
    typename G::vertex_descriptor vA,
    typename G::vertex_descriptor vB,
    PathInspector& pathInspector,
