#ifndef DINARA_LOCAL_ASSEMBLY_GRAPH_HPP
#define DINARA_LOCAL_ASSEMBLY_GRAPH_HPP
...
class dinara::LocalAssemblyGraphVertex {
public:
...
class dinara::LocalAssemblyGraphEdge {
public:
...
class dinara::LocalAssemblyGraph :
