...
Kmer dinara::getOrientedReadMarkerKmer(
...
Kmer dinara::getOrientedReadMarkerKmerStrand0(
    ReadId readId,
    uint32_t ordinal0,
    uint64_t k,
    const Reads& reads,
...
Kmer dinara::getOrientedReadMarkerKmerStrand1(
    ReadId readId,
    uint32_t ordinal1,
    uint64_t k,
    const Reads& reads,
...
KmerId dinara::getOrientedReadMarkerKmerId(
    OrientedReadId orientedReadId,
    uint32_t ordinal,
    uint64_t k,
    const Reads& reads,
