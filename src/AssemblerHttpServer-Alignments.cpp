...
void Assembler::writeColorPicker(ostream& html, string svgId){
    ...
    // Text labels
    html << R"stringDelimiter(
        <text x="290" y="100" font-size="26" font-weight="bold">Dinara Overlaps</text>
            ...
            if (nDelimiters == 0) {
                ...
                if (quality >= minQuality) {
                    ...
                    if (id != invalidReadId) {
                        ...
                        cout << "WARNING: skipping read not used in dinara assembly: " << readName << '\n';
                    }
                }
            }
    ...
    ostream& html)
{
    ...
    if(showAlignment){
        ...
        using seqan::Alignment; // Hide dinara::Alignment.
...
void Assembler::renderEditableAlignmentConfig(
    ...
    html << "<tr><th class=left>alignMethod<td>"
        ...
        (method==0 ? " checked=checked" : "") << "> 0 (Dinara)<br>"
        ...
        ostream& html)
{
    ...
    html << "<p>This page enables sampling from the pool of reads and computing alignments for each read in the sample "
            ...
            "generated and used to evaluate Dinara parameters."
            "<br>";
