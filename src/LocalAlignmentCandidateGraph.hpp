#ifndef DINARA_LOCAL_ALIGNMENT_CANDIDATE_GRAPH_HPP
#define DINARA_LOCAL_ALIGNMENT_CANDIDATE_GRAPH_HPP
...
class dinara::LocalAlignmentCandidateGraphVertex {
public:
...
class dinara::LocalAlignmentCandidateGraphEdge {
public:
...
class dinara::LocalAlignmentCandidateGraph :
