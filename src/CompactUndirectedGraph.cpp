...
void dinara::testCompactUndirectedGraph1()
{
    ...
    DINARA_ASSERT(g[v1] == 1.);
    g.doneAddingVertices();
    DINARA_ASSERT(g[v2] == 2.);
    ...
    DINARA_ASSERT(g[e01] == 10.);
    g.doneAddingEdges();
    DINARA_ASSERT(g[e23] == 30.);
...
void dinara::testCompactUndirectedGraph2()
{
