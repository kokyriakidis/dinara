#ifndef DINARA_LOCAL_MARKER_GRAPH0_HPP
#define DINARA_LOCAL_MARKER_GRAPH0_HPP
...
class dinara::LocalMarkerGraph0Vertex {
public:
...
class dinara::LocalMarkerGraph0Edge {
public:
...
class dinara::LocalMarkerGraph0 :
