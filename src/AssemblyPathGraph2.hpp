#ifndef DINARA_ASSEMBLY_PATH_GRAPH2_HPP
#define DINARA_ASSEMBLY_PATH_GRAPH2_HPP
...
class dinara::AssemblyPathGraph2Vertex {
public:
...
class dinara::AssemblyPathGraph2Edge {
public:
...
class dinara::AssemblyPathGraph2 : public AssemblyPathGraph2BaseClass {
public:
