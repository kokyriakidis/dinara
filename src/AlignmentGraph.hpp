#ifndef DINARA_ALIGNMENT_GRAPH_HPP
#define DINARA_ALIGNMENT_GRAPH_HPP
...
class dinara::AlignmentGraphVertex {
public:
...
class dinara::AlignmentGraphEdge {
public:
    uint64_t weight;
...
class dinara::AlignmentGraph : public AlignmentGraphBaseClass {
public:
