...
void AssemblyPathGraph::writeGraphviz(ostream& s) const
{
    ...
    BGL_FORALL_EDGES(e, graph, AssemblyPathGraph) {
        ...
        if(edge.tangle != invalidTangleId) {
            // Tangle edge.
            DINARA_ASSERT(edge.inTangle == invalidTangleId);
            DINARA_ASSERT(edge.outTangle == invalidTangleId);
...
bool AssemblyPathGraph::createTangleAtEdge(edge_descriptor e01)
{
    ...
    Tangle tangle;
    tangle.edge = e01;
    DINARA_ASSERT(graph[e01].tangle == invalidTangleId);
    ...
    TangleId tangleId) const
{
    ...
    DINARA_ASSERT(reverseComplementTangleId != invalidTangleId);
    ...
    vector<edge_descriptor>& newEdges)
{
    ...
    for(const edge_descriptor e: tangle.inEdges) {
        ...
        DINARA_ASSERT(edge.tangle == invalidTangleId);
    ...
    vector<edge_descriptor>& newEdges)
{
    ...
    */
    ...
    DINARA_ASSERT(BFollowsA or AFollowsB);  // By construction.
