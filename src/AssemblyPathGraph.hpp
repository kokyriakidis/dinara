#ifndef DINARA_ASSEMBLY_PATH_GRAPH_HPP
#define DINARA_ASSEMBLY_PATH_GRAPH_HPP
...
class dinara::AssemblyPathGraphVertex {
public:
...
class dinara::AssemblyPathGraphEdge {
public:
...
class dinara::AssemblyPathGraph : public AssemblyPathGraphBaseClass {
public:
