#ifndef DINARA_LOCAL_READ_GRAPH_HPP
#define DINARA_LOCAL_READ_GRAPH_HPP
...
class dinara::LocalReadGraphVertex {
public:
...
class dinara::LocalReadGraphEdge {
public:
