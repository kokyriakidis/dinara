#ifndef DINARA_COVERAGE_HPP
#define DINARA_COVERAGE_HPP
...
class dinara::CompressedCoverageData {
public:
...
static_assert(sizeof(dinara::CompressedCoverageData) == 3*sizeof(uint8_t),
