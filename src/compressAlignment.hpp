#ifndef DINARA_COMPRESS_ALIGNMENT_HPP
#define DINARA_COMPRESS_ALIGNMENT_HPP
...
class dinara::compressAlignment::Format0 {
public:
    ...
    Format0(
        ...
        formatIdentifier(id)
    {
        DINARA_ASSERT(ok(skip0Argument, skip1Argument, nArgument));
...
static_assert(sizeof(dinara::compressAlignment::Format0) == 1,
    "Unexpected size for dinara::compressAlignment::Format0");



class dinara::compressAlignment::Format1 {
public:
...
static_assert(sizeof(dinara::compressAlignment::Format1) == 2,
    "Unexpected size for dinara::compressAlignment::Format1");



class dinara::compressAlignment::Format2 {
public:
...
static_assert(sizeof(dinara::compressAlignment::Format2) == 4,
    "Unexpected size for dinara::compressAlignment::Format2");



class dinara::compressAlignment::Format3 {
public:
...
static_assert(sizeof(dinara::compressAlignment::Format3) == 8,
    "Unexpected size for dinara::compressAlignment::Format3");



class dinara::compressAlignment::Format4 {
public:
...
static_assert(sizeof(dinara::compressAlignment::Format4) == 16,
    "Unexpected size for dinara::compressAlignment::Format4");
