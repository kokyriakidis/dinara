#ifndef DINARA_TRANSITIVE_REDUCTION_HPP
#define DINARA_TRANSITIVE_REDUCTION_HPP
...
template<class Graph> void dinara::transitiveReduction(Graph &graph)
    {
...
template<class Graph> void dinara::transitiveReductionAny(Graph &graph)
    {
    using namespace boost;
    using vertex_descriptor = typename Graph::vertex_descriptor;
    using edge_descriptor = typename Graph::edge_descriptor;
