...
namespace dinara {
   const std::vector< pair<string, string> > configurationTable = {
    {"Nanopore-Dec2019", R"zzz(# This file contains Dinara options that, as of December 2019,
...
# To use this configuration file, specify Dinara option "--config PathToThisFile". 
...
consensusCaller = Bayesian:guppy-3.0.5-a
    ...
    {"Nanopore-UL-Dec2019", R"zzz(# This file contains Dinara options that, as of December 2019,
...
# This file contains Dinara options which attempt to partially automate
...
# To use this configuration file, specify Dinara option 
...
iterative = True
    ...
    {"Nanopore-OldGuppy-Sep2020", R"zzz(# This file contains Dinara options which attempt to partially automate
# parameter selection. It is based on an earlier config, which, as of Jun 2020,
# was known to work with Oxford Nanopore reads under the following circumstances:
...
# - Using Dinara at commit 266d4c8e65ff408db2dfd1381bb14648be83dad3.
...
pruneLength = 100
    ...
    {"Nanopore-Human-SingleFlowcell-May2022", R"zzz(# Dinara assembly configuration specialized for human assemblies
...
detangleMethod = 2
    ...
    {"Nanopore-Human-SingleFlowcell-Phased-May2022", R"zzz(# Dinara assembly configuration specialized for phased diploid 
...
pruneLength = 100
    ...
    {"Nanopore-R10-Fast-Nov2022", R"zzz(# This Dinara assembly configuration was tested under the following conditions:
...
detangleMethod = 2
    ...
    {"Nanopore-R10-Slow-Nov2022", R"zzz(# This Dinara assembly configuration was tested under the following conditions:
...
detangleMethod = 2
    ...
    {"Nanopore-Phased-R10-Fast-Nov2022", R"zzz(# This Dinara assembly configuration for phased diploid assembly
...
pruneLength = 100
    ...
    {"Nanopore-Phased-R10-Slow-Nov2022", R"zzz(# This Dinara assembly configuration for phased diploid assembly
# was tested under the following conditions:
...
[Assembly]
    ...
    {"Nanopore-r10.4.1_e8.2-400bps_sup-Herro-Sep2024", R"zzz(# Dinara assembly configuration for ONT r10.4.1_e8.2-400bps_sup reads,
...
mode3.primaryGraph.maxLoss = 0.5
    ...
    {"Nanopore-r10.4.1_e8.2-400bps_sup-Raw-Sep2024", R"zzz(# Dinara assembly configuration for ONT r10.4.1_e8.2-400bps_sup raw reads,
...
mode3.assemblyGraph.minLogP = 10
    ...
    {"Nanopore-r10.4.1_e8.2-400bps_sup-Herro-Jan2025", R"zzz(# Dinara assembly configuration for ONT r10.4.1_e8.2-400bps_sup reads,
# error-corrected with HERRO, as announced by Oxford Nanopore in May 2024:
# see https://labs.epi2me.io/lc2024_t2t/
