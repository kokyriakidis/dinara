#ifndef DINARA_GFA_ASSEMBLY_GRAPH_HPP
#define DINARA_GFA_ASSEMBLY_GRAPH_HPP
...
class dinara::GfaAssemblyGraphEdge {
public:
    string name;
...
template <class Vertex> class dinara::GfaAssemblyGraph :
