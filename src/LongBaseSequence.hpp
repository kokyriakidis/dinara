#ifndef DINARA_LONG_BASE_SEQUENCE_HPP
#define DINARA_LONG_BASE_SEQUENCE_HPP
...
class dinara::LongBaseSequenceView {
public:
    uint64_t* begin;
    uint64_t baseCount;
    bool readOnly;
...
inline std::ostream& dinara::operator<<(
    std::ostream& s,
    const dinara::LongBaseSequenceView& sequence)
{
...
class dinara::LongBaseSequence : public  LongBaseSequenceView {
public:
...
class dinara::LongBaseSequences {
public:
...
// Reverse complement a vector of bases.
inline void dinara::reverseComplement(vector<Base>&v)
{
