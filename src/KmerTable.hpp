#ifndef DINARA_KMER_TABLE_HPP
#define DINARA_KMER_TABLE_HPP
...
class dinara::KmerTable0 : public KmerTable {
public:
...
class dinara::KmerTable3: public KmerTable {
public:
