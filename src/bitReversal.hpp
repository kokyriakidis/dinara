...
inline uint16_t dinara::bitReversal(uint16_t x)
{
...
inline uint32_t dinara::bitReversal(uint32_t x)
{
...
inline uint64_t dinara::bitReversal(uint64_t x)
{
...
inline __uint128_t dinara::bitReversal(__uint128_t x)
{
