...
class dinara::mode3::LocalAssemblyGraphDisplayOptions {
public:
    uint64_t sizePixels;
    string layoutMethod;
...
class dinara::mode3::LocalAssemblyGraphVertex {
public:
...
class dinara::mode3::LocalAssemblyGraphEdge : public ChainIdentifier {
public:
...
class dinara::mode3::LocalAssemblyGraph : public LocalAssemblyGraphBaseClass {
public:
    LocalAssemblyGraph(
