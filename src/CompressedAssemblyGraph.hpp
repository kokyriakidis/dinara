#ifndef DINARA_COMPRESSED_ASSEMBLY_GRAPH_HPP
#define DINARA_COMPRESSED_ASSEMBLY_GRAPH_HPP
...
class dinara::CompressedAssemblyGraphVertex {
public:
...
class dinara::CompressedAssemblyGraphEdge {
public:
...
class dinara::CompressedAssemblyGraph :
