...
class dinara::mode3::LocalAssemblyDisplayOptions {
public:
...
class dinara::mode3::LocalAssemblyMarkerIndexes {
public:
...
class dinara::mode3::LocalAssemblyVertex {
public:
...
class dinara::mode3::LocalAssemblyEdge {
public:
...
class dinara::mode3::LocalAssembly : public LocalAssemblyBaseClass {
public:
...
private:
    ...
    public:
        ...
        {
            DINARA_ASSERT(not markerInfos.empty());
