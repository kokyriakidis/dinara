#ifndef DINARA_LOCAL_ALIGNMENT_GRAPH_HPP
#define DINARA_LOCAL_ALIGNMENT_GRAPH_HPP
...
class dinara::LocalAlignmentGraphVertex {
public:
...
class dinara::LocalAlignmentGraphEdge {
public:
...
class dinara::LocalAlignmentGraph :
