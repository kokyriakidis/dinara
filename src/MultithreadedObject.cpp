...
class dinara::MultithreadedObjectTestClass :
...
void dinara::MultithreadedObjectBaseClass::waitForThreads()
{
...
void dinara::MultithreadedObjectBaseClass::setupLoadBalancing(
    uint64_t nArgument,
...
bool dinara::MultithreadedObjectBaseClass::getNextBatch(
    uint64_t& begin,
    uint64_t& end)
{
...
void dinara::MultithreadedObjectBaseClass::killAllThreadsExceptMe(size_t me)
{
...
void dinara::testMultithreadedObject()
{
