...
void dinara::ReferenceOverlapMap::insert(string& region_name, uint32_t start, uint32_t stop, OrientedReadId id) {
...
void dinara::ReferenceOverlapMap::print(ostream& out){
...
dinara::ReferenceOverlapMap::ReferenceOverlapMap():
        intervals(),
        size(0)
{}
