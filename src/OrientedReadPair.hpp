#ifndef DINARA_ORIENTED_READ_PAIR_HPP
#define DINARA_ORIENTED_READ_PAIR_HPP
...
public:
    ...
    OrientedReadPair(
        ...
        isSameStrand(isSameStrand)
    {
        DINARA_ASSERT(readIds[0] != readIds[1]);
    }
    ...
    ReadId getOther(ReadId readIdA) const
    {
        if(readIdA == readIds[0]) {
            ...
            DINARA_ASSERT(readIdA == readIds[1]);
            return readIds[0];
        }
    }
