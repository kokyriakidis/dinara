#ifndef DINARA_ASSEMBLY_GRAPH2_HPP
#define DINARA_ASSEMBLY_GRAPH2_HPP
...
class dinara::AssemblyGraph2Vertex {
public:
...
class dinara::AssemblyGraph2Edge {
public:
