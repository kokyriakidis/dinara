...
void dinara::writeHtmlBegin(ostream& html, const string& title)
{
    html <<
        "<!DOCTYPE html>"
        "<html>"
...
void dinara::writeHtmlEnd(ostream& html)
{
    html << "</html>";
}
...
void dinara::writeStyle(ostream& html)
{
    html << R"%(
<style>
    body {
...
void dinara::addSvgDragAndZoom(ostream& html)
{
    html << R"zzz(  
<script>
...
void dinara::writeInformationIcon(ostream& html, const string& message)
{
